    ...
    $(this).scrollTop() > 200
        ? (
            ...
            scrollHeight - scrollPosition <= footHeight
                ? ($("#ptop").addClass("end"), $(".sp .snsbtn.btm").addClass("end"))
                : ($("#ptop").removeClass("end"), $(".sp .snsbtn.btm").removeClass("end"))
        )
...
$(function () {
    ...
    $(".mOpen").on("click", function () {
        $(this).next(".mCover").hasClass("this")
            ? $(".mCover.this").fadeOut("fast").removeClass("this")
            : ($(".mCover").fadeOut("fast").removeClass("this"), $(this)
                .next(".mCover")
                .fadeIn("fast")
                .addClass("this"))
    }),
    ...
    snsiconsize = $("body.idx").size()
        ? "l"
        : "m";
    try {
        $("body.ondemand.detail").size() || setTimeout(function () {
            NHKSNS.initSNS({iconsize: snsiconsize, disable: "line", guidepos: "nothing"})
        }, 700)
    } catch (e) {}
    $(window).on("load scroll", function () {
        ...
        $(window).scrollTop() > 200
            ? $("#contentsHead").addClass("fixed")
            : $("#contentsHead").removeClass("fixed")
    })
}),
...
function (e) {
    window.XDomainRequest && e.ajaxTransport(function (i) {
        ...
        if (i.crossDomain && i.async) 
            return i.timeout && (i.xdrTimeout = i.timeout, delete i.timeout), {
                send: function (a, o) {
                    function s(i, a, s, t) {
